...
protocol ForeignManualControlSensing: Sendable {
    ...
    /// restore contest ADR 0011 declines. It judges nothing and logs nothing: unlike
    /// `refusalForGrant`, a fan reading manual here is a fan Aeolus has just tried to hand
    /// back, and calling it foreign would be the wrong reason in the log.
