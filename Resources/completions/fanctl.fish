...
complete -c 'fanctl' -n '__fanctl_should_offer_completions_for_positional "fanctl" -eq 1' -fa 'status' -d 'Show what the helper reports about every fan and who holds them.'
...
complete -c 'fanctl' -n '__fanctl_should_offer_completions_for_flags_or_options "fanctl status" json' -l 'json' -d 'Emit one JSON document instead of text.'
complete -c 'fanctl' -n '__fanctl_should_offer_completions_for_flags_or_options "fanctl status" version' -l 'version' -d 'Show the version.'
complete -c 'fanctl' -n '__fanctl_should_offer_completions_for_flags_or_options "fanctl status" h help' -s 'h' -l 'help' -d 'Show help information.'
