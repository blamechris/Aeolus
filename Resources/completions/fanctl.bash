...
_fanctl_sensors() {
    repeating_flags=()
    non_repeating_flags=(--json --raw-keys --version -h --help)
    repeating_options=()
    non_repeating_options=()
    __fanctl_offer_flags_options 0
}
...
_fanctl_watch() {
    ...
    non_repeating_flags=(--json --version -h --help)
    repeating_options=()
    non_repeating_options=(--interval --count)
    __fanctl_offer_flags_options 0
...
_fanctl_reset() {
    repeating_flags=()
    non_repeating_flags=(--all --version -h --help)
    repeating_options=()
    non_repeating_options=()
    __fanctl_offer_flags_options 0
}
...
complete -o filenames -F _fanctl fanctl
