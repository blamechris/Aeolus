...
# Aeolus does not use complexity labels. Sizing lives in the epic checklist,
# and the model tier suggested in the issue body carries the same signal.
...
<!-- skill-templates: create-issue 12b011f 2026-07-25 -->
