...
# Add safety-critical when the deferred item touches the helper, the SMC write path,
# the XPC boundary, or a mechanism in docs/SAFETY.md — those are triaged first.
...
<!-- skill-templates: check-pr cc062bc 2026-07-25 -->
