...
///
/// `ThermalEmergencyRecordStalenessTests` is this suite's sibling for the mirror case — the
/// *reading itself* going stale rather than a fact about the episode. That mechanism is
/// `CriticalTemperatureCache.record(_:since:)`, not the latch, which is why it moved out in
/// [#287](https://github.com/blamechris/Aeolus/issues/287) rather than growing this file
/// further.
///
/// ## Scripted, not raced
///
