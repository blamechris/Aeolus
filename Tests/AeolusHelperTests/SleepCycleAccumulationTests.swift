...
struct SleepCycleAccumulationTests {
    ...
    /// suites … with 3 issues`, 32.7 s). **This is the mutation the rest of the list does not
    ...
    /// 220 suites … with 1 issue`, 30.5 s on a quiet machine). This is the mutation the register
